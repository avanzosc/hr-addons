...
class AccountAnalyticLine(models.Model):
    ...
    def _compute_session_schedule(self):
        for line in self:
            schedule = ""
            if line.event_track_id and line.event_track_id.date and line.unit_amount:
                timezone = pytz.timezone(line.event_track_id.event_id.date_tz or "UTC")
                ...
                new_date = track_date + relativedelta(hours=+line.unit_amount)
                schedule = "{} - {}:{}:{}".format(
                    schedule,
