...
class StockMove(models.Model):
    ...
    def get_name_and_size(self):
        ...
        range_pattern = (
            r"\b(XS|S|M|L|XL|2XL|3XL|4XL|5XL|XXL|XXXL)\s*-\s*"
            r"(XS|S|M|L|XL|2XL|3XL|4XL|5XL|XXL|XXXL)\b"
        )
        ...
        range_pattern_simple = (
            r"^(XS|S|M|L|XL|2XL|3XL|4XL|5XL|XXL|XXXL)\s*-\s*"
            r"(XS|S|M|L|XL|2XL|3XL|4XL|5XL|XXL|XXXL)$"
        )
        last_two_words = (
            f"{second_last_word} {last_word}" if second_last_word else last_word
        )
